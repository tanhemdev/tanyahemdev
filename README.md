...
TAN-1 — Non-invasive diabetes management ecosystem. Leading product vision, user research, and Figma prototyping grounded in a 92%-accuracy risk model
Kaiser Permanente — AI messaging product for 2M+ health plan members (Gen Z Proactive Messaging initiative)
Fung Fellowship — Health + Innovation track. Shipping a digital health MVP with a cross-functional team of engineers and data scientists


🗂️ Featured Projects
ProjectStackDescriptionTAN-1 Diabetes EcosystemFigma, Predictive ModelingNon-invasive diabetes PM + UX case studyNeuro-Accessible Learning PlatformerPython, OpenCV, MediaPipeHand-gesture controller — sub-100ms latencyAI-Assisted Speech MonitoringFigma, UX ResearchPRD + usability research for neurological patients

🧰 Skills
Product · Roadmaps · PRDs · Agile/Scrum · OKRs · RICE · MoSCoW · A/B Testing · Go-to-Market
Data · Python (Pandas, NumPy) · SQL · Power BI · Cohort Analysis · Funnel Analysis
